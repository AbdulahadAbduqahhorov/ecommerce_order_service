...
type OrderRepoI interface {
	CreateOrder(id string, req *order_service.CreateOrderRequest) (*order_service.CreateOrderResponse, error)
	GetOrderList(req *order_service.GetOrderListRequest) (*order_service.GetOrderListResponse, error)
	GetOrderById(id string) (*order_service.GetOrderByIdResponse, error)
}
